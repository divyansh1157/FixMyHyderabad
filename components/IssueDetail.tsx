      ...
      <div className="bg-white rounded-2xl overflow-hidden shadow-sm border border-slate-200">
        ...
        <div className="p-6 sm:p-8">
          ...
          <div className="flex items-center gap-2 flex-wrap mb-4">
            <span
              className={`text-xs font-bold uppercase tracking-wider px-3 py-1.5 rounded-md border ${cat.pill}`}
            >
              {cat.emoji} {tc(report.category as any)}
            </span>
            {urgency && (
              <span
                className={`text-xs font-bold uppercase tracking-wider px-3 py-1.5 rounded-md border ${urgency.cls}`}
              >
                {urgency.label}
              </span>
            )}
          ...
          {/* Title */}
          <h1 className="font-bold text-slate-800 text-2xl sm:text-3xl leading-tight mb-3">
            {report.title}
          </h1>
          ...
          <div className="border-t border-slate-200 pt-6 grid grid-cols-3 gap-4">
            ...
            <div className="text-center">
              ...
              <p className="text-xs text-slate-600 font-medium mt-1 capitalize">
                {report.status}
              </p>
            </div>
          </div>
