    ...
    <div className="bg-white border border-[#1A1208]/8 rounded-2xl overflow-hidden shadow-sm hover:shadow-md hover:-translate-y-0.5 transition-all duration-200 h-full flex flex-col">
      ...
      <div className="p-4 flex flex-col flex-1">
        ...
        <Link href={`/${locale}/issues/${report.id}`}>
          <h3 className="font-extrabold text-[#1A1208] text-base leading-snug mb-1 hover:text-[#E8520A] transition-colors" style={{ fontFamily: 'var(--font-syne), sans-serif' }}>
            {report.title}
          </h3>
        </Link>
        ...
        <div className="border-t border-[#1A1208]/6 pt-3 space-y-2">
          ...
          <Link
            ...
            className="block text-center text-[11px] font-semibold text-[#E8520A] hover:underline"
          >
            {t('viewDetails')}
          </Link>
        </div>
